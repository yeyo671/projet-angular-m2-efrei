...
import { Firestore, collection, addDoc, getDocs, doc, getDoc, deleteDoc, query, where, DocumentData } from '@angular/fire/firestore';
...
export class ProductService {
  ...
  async getProductsByUserId(userId: string): Promise<ProductWithUserEmail[]> {
